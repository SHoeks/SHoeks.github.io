            ...
            return i(e, [{
                ...
                value: function(t) {
                    ...
                    Object.entries(this.els).forEach((function(l) {
                        ...
                        // //!! add fade in when in view
                        if (i >= c.top && c.el.classList[0]=="project")  { 
                            c.el.children[0].children[0].className = "project__thumb fadein"
                        }
        ...
        ct = function(e) {
            ...
            return i(n, [{
                ...
                value: function(t) {
                    ...
                    Object.entries(this.parallaxElements).forEach((function(l,idx) {
                        var r = f(l, 2),
                        a = (r[0], r[1]),
                        c = !1;
...
var app = function() {
    ...
    barba.hooks.once((data) => {
        ...
        //!! new code for image animations
        // console.log("adding fadein to images");
        // imob = $( ".project__thumb" );
        // for( i = 0; i < imob.length; i++) imob[i].className = imob[i].className + " fadein";
